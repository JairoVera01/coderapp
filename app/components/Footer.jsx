...
function Footer() {
  return (
    <footer className="rounded-none bg-white p-4 py-8  md:p-8 lg:p-10">
      <div className="mx-auto max-w-screen-xl text-center">
        <div className="grid lg:grid-cols-3">
          ...
          <ul className="mb-4 flex flex-wrap items-center text-sm text-gray-500  lg:mb-0">
            <li>
          ...
          <form action="#" className="flex w-full max-w-sm lg:ml-auto">
            <div className="relative w-full">
              ...
              <input
                type="email"
                id="email"
                className="block w-full rounded-l-lg border border-gray-300 bg-gray-50 p-3 pl-10 text-sm text-gray-900 focus:border-primary-500 focus:ring-primary-500 "
            ...
            <button
              type="submit"
              className="cursor-pointer rounded-r-lg border border-primary-600 bg-primary-600 px-5 py-3 text-center text-sm text-white hover:bg-primary-700 focus:ring-4 focus:ring-primary-300 "
            >
              Subscribe
            </button>
          </form>
